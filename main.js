...
function validar() {
  ...
  if (op === true) {
    ...
    informacion[indice].tipoDocumento = document.querySelector(
      'input[name="identificacion"]:checked').value;
    informacion[indice].numeroDocumento = document.getElementById(
      "numeroidentificacion"
    ).value;
    informacion[indice].genero = document.querySelector('input[name="genero"]:checked').value;
    informacion[indice].fechaNacimiento =
      document.getElementById("fecha").value;
    informacion[indice].telefono =
      document.getElementById("numerodetelefono").value;
    informacion[indice].correo =
